...
public class InitDB {
  ...
  static class InitService {
    ...
    public void dbInit() {
      ...
      Shop lotteOnShop = new Shop("lotteOn",
          "https://ko.m.wikipedia.org/wiki/%ED%8C%8C%EC%9D%BC:Lotte_%22Value_Line%22_logo.svg");
      Shop trenbeShop = new Shop("trenbe",
          "https://www.techm.kr/news/thumbnail/202008/74445_67428_1335_v150.jpg");
      Shop mustitShop = new Shop("mustit",
          "https://s3.ap-northeast-2.amazonaws.com/mustit-ux/img/m/m_common/ban_share_common.png");
      Shop musinsaShop = new Shop("musinsa",
          "https://pds.saramin.co.kr/company/logo/202202/21/r7n4lg_iaut-i637x_logo.JPG");
      ...
      Channel channel = new Channel("핏더사이즈",
          "https://www.youtube.com/c/%ED%95%8F%EB%8D%94%EC%82%AC%EC%9D%B4%EC%A6%88/about",
      ...
      Item item1 = Item.builder()
          ...
          .imgUrl(
              "https://www.lotteon.com/m/product/LO1865153271?sitmNo=LO1865153271_1865153272&mall_no=1&dp_infw_cd=SCH%EA%B0%A4%EB%9F%AC%EB%A6%AC%EB%94%94%ED%8C%8C%ED%8A%B8%EB%A8%BC%ED%8A%B8")
          .build();
      ...
      Item item2 = Item.builder()
          ...
          .imgUrl(
              "https://cdn.mustit.co.kr/lib/upload/product/luxboy/2022/05/1653037065-72.jpeg/_dims_/resize/500x500/extent/500x500")
          .build();
      ...
      Item item3 = Item.builder()
          ...
          .imgUrl(
              "https://image.msscdn.net/images/prd_img/20220519/2569788/detail_2569788_10_500.jpg?t=20220530104204")
          .build();

      ShopItem shopItem1 = ShopItem.builder()
          .shop(lotteOnShop)
          .itemImgUrl(
              "https://contents.lotteon.com/itemimage/_v143540/LO/18/65/15/32/71/_1/86/51/53/27/2/LO1865153271_1865153272_1.png/dims/optimize/dims/resizemc/400x400")
          .itemUrl(
              "https://www.lotteon.com/m/product/LO1865153271?sitmNo=LO1865153271_1865153272&mall_no=1&dp_infw_cd=SCH%EA%B0%A4%EB%9F%AC%EB%A6%AC%EB%94%94%ED%8C%8C%ED%8A%B8%EB%A8%BC%ED%8A%B8")
          .price(250000L)
          .item(item1)
      ...
      ShopItem shopItem2 = ShopItem.builder()
          .shop(trenbeShop)
          .itemImgUrl(
              "https://image-cdn.trenbe.com/productmain/1655965617308-11fdd4fc-163a-41f8-9351-56ec85cf1958.jpeg")
