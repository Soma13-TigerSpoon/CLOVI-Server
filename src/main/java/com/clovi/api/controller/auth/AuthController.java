package com.clovi.api.controller.auth;


import com.clovi.api.response.BaseResponse;
import com.clovi.api.response.MessageCode;
import com.clovi.dto.requests.auth.LoginRequest;
import com.clovi.dto.requests.auth.TokenRequest;
import com.clovi.dto.response.auth.TokenResponse;
import com.clovi.service.auth.AuthService;
...
public class AuthController {
  ...
  public ResponseEntity login(@Validated @RequestBody LoginRequest loginRequest){
    ...
    return ResponseEntity.ok(new BaseResponse(token, HttpStatus.OK.value(), MessageCode.SUCCESS_LOGIN));
  }
  ...
  public ResponseEntity getToken(@Validated @RequestBody TokenRequest tokenRequest) {
    ...
    return ResponseEntity.ok(new BaseResponse(token, HttpStatus.OK.value(), MessageCode.SUCCESS_GET_TOKEN));
  }
}
