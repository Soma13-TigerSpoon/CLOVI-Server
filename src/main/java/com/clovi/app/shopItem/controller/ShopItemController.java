package com.clovi.app.shopItem.controller;
...
import com.clovi.app.shopItem.service.ShopItemService;
...
public class ShopItemController {
  ...
  @Operation(summary = "Create shop link", description = "Save shop link of domain", responses = {
