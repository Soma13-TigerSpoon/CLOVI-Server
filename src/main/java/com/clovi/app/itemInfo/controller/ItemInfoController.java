package com.clovi.app.itemInfo.controller;
...
import com.clovi.app.itemInfo.service.ItemInfoService;
...
public class ItemInfoController {
  ...
  @Operation(summary = "Find itemInfo", description = "Find information of domain by ID", responses = {
          @ApiResponse(responseCode = "200", description = "Success Find information of domain", content = @Content(schema = @Schema(implementation = ItemResponse.class)))
  })
  ...
  */
  ...
  @Operation(summary = "Create itemInfo", description = "Create information of domain and save", responses = {
  ...
  @Operation(summary = "Update itemInfo", description = "Update information of domain", responses = {
  ...
  @Operation(summary = "Delete itemInfo", description = "Delete information of domain", responses = {
